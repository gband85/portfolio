...
const Page=()=>{
    return (
      ...
      <div class="project-cards">     
            ...
            <img src={images['tribute.png']} class="card__img" alt=""/>
              ...
              <a href="projects/survey">
                  <img src={images['survey.png']} class="card__img" alt=""/>
            ...
            <img src={images['product.png']} class="card__img" alt=""/>
            ...
            <div class="card">
              <a href="/projects/doc">
            <img src={images['doc.png']} class="card__img" alt=""/>
            ...
            <img src={images['quotes.png']} class="card__img" alt=""/>
            ...
            <img src={images['markdown.png']} class="card__img" alt=""/>
            ...
            <img src={images['drum-machine.png']} class="card__img" alt=""/>
            ...
            <img src={images['calculator.png']} class="card__img" alt=""/>
              ...
              <a href="./projects/clock-js">
                  <img src={images['clock.png']} class="card__img" alt=""/>
            ...
            <img src={images['weather.png']} class="card__img" alt=""/>
            ...
            <img src={images['wikipedia.png']} class="card__img" alt=""/>
            ...
            <img src={images['landing_page.png']} class="card__img" alt=""/>
            ...
            <img src={images['restaurant.png']} class="card__img" alt=""/>
            ...
            <img src={images['sign_up_form.jpg']} class="card__img" alt=""/>
          ...
          <img src={images['resume_builder.png']} class="card__img" alt=""/>
    ...
    <div class="contact">
    <a href="mailto:mail@gbanderson.net" class="btn btn-pr/imary"><span><i
    class="fa-solid fa-envelope"></i></span>  Email Me!</a>
      <a href="https://github.com/gband85" class="btn btn-primary" target="_blank" rel="noreferrer"><span><i
            class="fa-brands fa-github"></i></span>  Github</a>
      <a href="https://www.linkedin.com/in/garrettanderson85/" class="btn btn-primary"
        target="_blank" rel="noreferrer"><span><i class="fa-brands fa-linkedin"></i></span> LinkedIn</a>
      <a href="https://www.freecodecamp.org/gband85" id="profile-link" class="btn btn-primary"
        target="_blank" rel="noreferrer"><span><i class="fa-brands fa-free-code-camp"></i></span> FreeCodeCamp</a>
    </div>
    </div>
    </div> 
